...
[Single-Panorama Classification of 3D Objects Using Horizontally Stacked Dilated Convolutions](https://ieeexplore.ieee.org/abstract/document/10647442) - IEEE International Conference on Image Processing (ICIP) 2024

[Spherically-Weighted Horizontally Dilated Convolutions for Omnidirectional Image Processing](https://ieeexplore.ieee.org/abstract/document/10716273) - 37th SIBGRAPI Conference on Graphics, Patterns and Images (SIBGRAPI) 2024

[Noise Reduction with Detail Preservation in Low-Dose Dental CT Images by Morphological Operators and BM3D](https://link.springer.com/chapter/10.1007/978-3-030-49342-4_30) - International Conference on Intelligent Systems Design and Applications (ISDA) 2019

[Low-Dose CT Dental Image Denoising by Morphological Operators and 3D Filtering](https://ieeexplore.ieee.org/abstract/document/8919773) - 32nd SIBGRAPI Conference on Graphics, Patterns and Images (SIBGRAPI) 2019

[A Mathematical Morphology-Based Filter for Noise Reduction and Detail Preservation in Low-Dose Dental CT Images](https://books.google.ca/books?id=m--9DwAAQBAJ&lpg=PA253&ots=qhvZAH7grn&dq=info%3ATlQnCjgXE9IJ%3Ascholar.google.com&lr&pg=PA253#v=onepage&q&f=false) - World Congress on Medical and Health Informatics (MEDINFO) 2019
